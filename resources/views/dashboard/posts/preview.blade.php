    ...
    <div class="row mb-5 mt-3">
        <div class="col-lg-8">
                <h2 class="mb-3">{{ $post->title }}</h2>
                    <a href="/dashboard/posts" class="btn btn-success"> <span data-feather="arrow-left"></span> Kelola postingan</a>
                    ...
                    <form action="/dashboard/posts/{{ $post->slug }}" method="post" class="d-inline">
                      ...
                      @else
                        <img src="https://source.unsplash.com/1100x350?{{ $post->category->name }}" class="img-fluid mt-3">
                      @endif
